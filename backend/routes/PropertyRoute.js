...
const {
  getAllProperties, createProperty, updateProperty, deleteProperty, getAdminProperties,
  getTopListings,getPropertyLocation, sendAgentEmail,getRentalProperties, getSaleProperties, getAgentProperties
